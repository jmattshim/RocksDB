...
void rocksdb_options_set_csd_offload(rocksdb_options_t* opt, int csd_offload) {
  opt->rep.csd_offload = csd_offload;
}

void rocksdb_options_set_crc_accel(rocksdb_options_t* opt, int crc_accel) {
  opt->rep.crc_accel = crc_accel;
}
...
void rocksdb_readoptions_set_read_offload(rocksdb_readoptions_t* opt,
                                          unsigned char v) {
  opt->rep.read_offload = v;
}

unsigned char rocksdb_readoptions_get_read_offload(rocksdb_readoptions_t* opt) {
  return opt->rep.read_offload;
}
