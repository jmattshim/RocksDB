...
Status ExternalSstFileIngestionJob::Run() {
  ...
  for (IngestedFileInfo& f : files_to_ingest_) {
    ...
    FileMetaData f_metadata(
        ...
        f.user_defined_timestamps_persisted, f.table_properties.index_size,
        f.table_properties.num_entries, f.table_properties.filter_size,
        f.table_properties.num_data_blocks);
