...
struct FileMetaData {
  ...
  // The number of entries, including deletions and range deletions.
  // Persist num_entries for CSD offloading
  uint64_t num_entries = 0;

  // size of filter block
  ...
  FileMetaData(uint64_t file, uint32_t file_path_id, uint64_t file_size,
               ...
               uint64_t _tail_size, bool _user_defined_timestamps_persisted, uint64_t _index_size,
               uint64_t _num_entries, uint64_t _filter_size, uint64_t _num_data_blocks)
  ...
  // Used for CSD compaction.
  Status SetBoundaries(const Slice& smallest_key, const Slice& largest_key,
...
class VersionEdit {
 public:
  ...
  void AddFile(int level, uint64_t file, uint32_t file_path_id,
               ...
               uint64_t index_size, uint64_t num_entries, uint64_t filter_size,
    ...
    new_files_.emplace_back(
        ...
        FileMetaData(file, file_path_id, file_size, smallest, largest,
                     ...
                     user_defined_timestamps_persisted, index_size, num_entries,
                     filter_size, num_data_blocks));
