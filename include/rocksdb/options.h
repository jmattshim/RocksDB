...
struct DBOptions {
  ...
  // By default, Rocksdb will perform host mode compaction.
  bool csd_offload = false;

  // By default, Rocksdb will not use CRC sequence-of-execution
  bool crc_accel = false;

  // By default, use the standard CSD compaction path (manual memory allocation)
  // When true, use magic command where CSD handles memory allocation internally
  bool csd_magic = false;

  // When true, use magic read command where CSD handles memory allocation
  // and file loading internally for read offloading
  bool read_magic = false;

  // By default, read operations will not be offloaded
...
struct ReadOptions {
  ...
  // By default, Rocksdb will perform host mode read
  bool read_offload = false;
