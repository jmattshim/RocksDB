    ...
    db_immutable_options_type_info = {
        ...
        {"use_fsync",
         {offsetof(struct ImmutableDBOptions, use_fsync), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"csd_offload",
         {offsetof(struct ImmutableDBOptions, csd_offload), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"crc_accel",
         {offsetof(struct ImmutableDBOptions, crc_accel), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"csd_magic",
         {offsetof(struct ImmutableDBOptions, csd_magic), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"read_magic",
         {offsetof(struct ImmutableDBOptions, read_magic), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
        {"read_offload",
         {offsetof(struct ImmutableDBOptions, read_offload), OptionType::kBoolean,
          OptionVerificationType::kNormal, OptionTypeFlags::kNone}},
...
ImmutableDBOptions::ImmutableDBOptions(const DBOptions& options)
    : create_if_missing(options.create_if_missing),
      ...
      csd_offload(options.csd_offload),
      crc_accel(options.crc_accel),
      csd_magic(options.csd_magic),
      read_magic(options.read_magic),
      read_offload(options.read_offload),
...
void ImmutableDBOptions::Dump(Logger* log) const {
  ...
  ROCKS_LOG_HEADER(log, "                              Options.use_fsync: %d",
                   use_fsync);
  ROCKS_LOG_HEADER(log, "                              Options.csd_offload: %d",
                   csd_offload);
  ROCKS_LOG_HEADER(log, "                              Options.crc_accel: %d",
                   crc_accel);
  ROCKS_LOG_HEADER(log, "                              Options.csd_magic: %d",
                   csd_magic);
  ROCKS_LOG_HEADER(log, "                              Options.read_offload: %d",
                   read_offload);
  ROCKS_LOG_HEADER(log, "                              Options.read_magic: %d",
                   read_magic);
  ROCKS_LOG_HEADER(
