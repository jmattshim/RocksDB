...
class BlockBasedTable : public TableReader {
 public:
  ...
  Status CacheGet(const ReadOptions& original_readOptions, const Slice& key,
             GetContext* get_context, const SliceTransform* prefix_extractor,
             bool skip_filters = false, struct CSD_PARAMS* params = nullptr,
             int search_level = 0, bool* is_included = nullptr);
