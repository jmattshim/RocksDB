...
DEFINE_bool(csd_offload, false, "use csd for compaction offloading");
...
DEFINE_double(compression_ratio, 1,
...
DEFINE_string(compressed_secondary_cache_compression_type, "none",
...
DEFINE_string(
    blob_db_compression_type, "none",
    "[Stacked BlobDB] Algorithm to use to compress blobs in blob files.");
static enum ROCKSDB_NAMESPACE::CompressionType
    FLAGS_blob_db_compression_type_e = ROCKSDB_NAMESPACE::kNoCompression;
...
// Current the following isn't equivalent to OS_LINUX.
 ...
 private:
  ...
  void InitializeOptionsGeneral(Options* opts) {
    ...
    if (FLAGS_csd_offload) {
      options.csd_offload = true;
    }
...
int db_bench_tool(int argc, char** argv) {
  ...
  /* My Configurations */
  // FLAGS_seed = 1721871182244959;
  // FLAGS_db = "/mnt/nvme/dbbench";
  // FLAGS_value_size = 4096;
  // FLAGS_benchmarks = "fillrandom";
  // FLAGS_num = 10000000;
  // FLAGS_reads = 0;
  // FLAGS_compression_ratio = 1;
  // FLAGS_cache_size = (google::int64) 8 << 30;
  // FLAGS_csd_offload = false;
